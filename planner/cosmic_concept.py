...
채널 철학: "우주의 시선으로 보면, 지금 네 고민은 아무것도 아니야."
오늘 업로드할 1시간 우주/코스믹 앰비언트 영상의 콘셉트를 만들어줘.
...
1. emotion_copy: 감정/상황 카피 (제목 앞부분, 30자 이내)
   - 시청자의 감정 상황을 직접 건드리는 문장
   - 우주/신비 70% + 위로/감성 30% 톤
   - ✅ 좋은 예: "오늘 밤은 우주 속으로 사라져도 괜찮아", "머릿속이 복잡할 때 별빛 속으로 빨려드는 소리", "잠이 안 올 때 틀어두면 되는 영상"
   - ❌ 금지: "지친 마음을 내려놓고 별빛 속으로 잠겨보세요" (평범한 위로 문구), 카테고리명 직접 언급
   - 최근 제목과 겹치지 않게
